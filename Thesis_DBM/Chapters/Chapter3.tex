...
\begin{minipage}{.3\textwidth}
      \includegraphics[width=\linewidth, height=35mm, valign=T]{EulerAngles}
\end{minipage}
\\
% Row 1 end
\hline
...
\bigskip
\begin{minipage}{.3\textwidth}
      \includegraphics[width=70mm, height=25mm]{Quaternion to Euler conversion}
\end{minipage}
\\
% Row 1 end
\hline
...
\begin{figure}[h]
  \centering
  \includegraphics[width=14cm, height=10cm]{Architect 3}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=13cm, height=10cm]{Audio Methodology}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm, height=6cm]{Controller Application Methodology}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm, height=7cm]{Main_Camera}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm, height=5cm]{Player Application Methodology (Offline)}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm, height=5cm]{Player Application Methodology (Online)}
